...
import { ImportResultat } from "../../../models/capture-estimee.model";
...
@Component({
  selector: "app-import-captures-estimees",
  standalone: true,
  imports: [CommonModule],
  templateUrl: "./import-captures-estimees.component.html",
  styleUrl: "./import-captures-estimees.component.scss",
})
export class ImportCapturesEstimeesComponent {
  ...
  upload(): void {
    ...
    this.svc.importerExcel(this.selectedFile, annee).subscribe({
      next: (r) => {
        this.isUploading = false;
        this.resultatImport = r;
        // if (this.resultatImport.captures_importees === 0) {
        //   M.toast({
        //     html: `${this.resultatImport.captures_importees} captures importés avec succès.`,
        //     classes: "green",
        //   });
        // } else {
        //   M.toast({
        //     html: `Import terminé : ${this.resultatImport.captures_importees} insérés, ${this.resultatImport.efforts_importes} en échec.`,
        //     classes: "orange",
        //   });
        // }
        M.toast({
          html: `Import terminé : ${this.resultatImport.captures_importees} captures insérées, ${this.resultatImport.efforts_importes} efforts de pêche importés.`,
          classes: "green",
        });
        this.reset();
      },
