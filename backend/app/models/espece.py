from sqlalchemy import Column, Integer, String, Float, DateTime, Enum, Boolean, Text, LargeBinary
...
class Espece(Base):
    ...
    code_espece = Column(String(20), unique=True, nullable=False, index=True)  # Code FAO ou national
    ...
    statut_reglementaire = Column(Enum(StatutReglementaire), nullable=False, default=StatutReglementaire.LIBRE)
